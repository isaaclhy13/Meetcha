...
export default function signupEmail({navigation}) {
    ...
    return (
        <SafeAreaView style={{height: HEIGHT, width: WIDTH, }}>
            ...
            <TouchableOpacity disabled={email == '' ? true : false} onPress={()=>navigation.navigate('signupPassword', {email:email})} style={{height:HEIGHT*0.08, width:WIDTH*0.85, borderRadius:40, 
             backgroundColor: email == '' ? '#e3e3e3' : '#FEC357', alignSelf:'center', justifyContent:'center'}}>
