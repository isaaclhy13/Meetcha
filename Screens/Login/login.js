    ...
    return (
        <SafeAreaView style={{height: HEIGHT, width: WIDTH, backgroundColor:'#FEC357' }}>
            ...
            <View style={{ width:WIDTH, height:HEIGHT*0.3,paddingLeft:WIDTH*0.1, }}>
                ...
                <TextInput placeholder='Email' autoFocus={true} onChangeText={(value)=> setEmail(value)} value={email} style={{height:HEIGHT*0.065, width:WIDTH*0.8, borderRadius:40,
                backgroundColor:'white', borderWidth:2, borderColor:'#E0E0E0', marginTop:HEIGHT*0.05, paddingLeft:WIDTH*0.05}}/>
                <TextInput placeholder='Password' onChangeText={(value)=> setPassword(value)} value={password} style={{height:HEIGHT*0.065, width:WIDTH*0.8, borderRadius:40,
                backgroundColor:'white', borderWidth:2, borderColor:'#E0E0E0', marginTop:HEIGHT*0.02, paddingLeft:WIDTH*0.05}}/>
            </View>
            <TouchableOpacity disabled={(email == '' || password == '') ? true : false} onPress={onLogin} style={{height:HEIGHT*0.08, width:WIDTH*0.85, 
